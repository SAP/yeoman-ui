...
export default {
  ...
  change_owner_for_global: (globalNpmPath: string) => `Change owner ${globalNpmPath} to current user (recommended).\n
  Admin access required`,
  no_write_access: (globalNpmPath: string) => `You do not have write access to directory "${globalNpmPath}".\n
