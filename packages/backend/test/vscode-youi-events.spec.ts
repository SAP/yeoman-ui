...
describe("vscode-youi-events unit test", () => {
  ...
  describe("doGeneratorDone", () => {
    ...
    it("on success, targetFolder is uri and workspace needs reload --> trigger workspace refresh", () => {
      ...
      commandsMock
        .expects("executeCommand")
        .withArgs("workbench.action.reloadWindow")
        .resolves();
  
      events.doGeneratorDone(true, "success message", addToWorkspace, "project", '{"uri":"abapdf://testDestinationRoot","name":"projectName"}');
    });
