...
describe("workspaceFolders utility tests", () => {
  ...
  describe("getWorkspaceFolders", () => {
    ...
    it("returns empty array when workspaceFolders is null", () => {
    ...
    it("handles workspace folders with null/undefined properties", () => {
      const mockFolders: any[] = [
        {
          uri: Uri.file("/valid/path"),
          name: "valid",
          index: 0,
        },
        null,
        ...
        {
          uri: Uri.file("/another/valid/path"),
          name: "valid2",
          index: 3,
        },
      ];
