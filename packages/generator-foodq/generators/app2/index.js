...
module.exports = class extends Generator {
  constructor(args, opts) {
    ...
    this.argument("isDelivery", {
      type: Boolean,
      required: false,
      default: silent ? true : undefined,
    });
    this.argument("deliveryMethod", {
      type: Array,
      required: false,
      default: silent ? "Drone" : undefined,
    });
    this.argument("address", {
      type: String,
      required: false,
      default: silent ? "the best street" : undefined,
    });
    this.argument("tip", {
      type: Number,
      required: false,
      default: silent ? 20 : undefined,
    });

    this.dynamicAddressPrompt = {
      name: "Address",
      description: "Provide the address for delivery.",
    };

    const prompts = [
      {
        name: "Delivery",
        description: "Select your prefered delivery method.",
      },
      this.dynamicAddressPrompt,
      {
        name: "Tip",
        description: "You can include a tip for the delivery person.",
      },
    ];
