...
export class YeomanUIPanel {
    ...
    private defaultNpmPath: any;

	public constructor(panel: vscode.WebviewPanel, rpc: RpcExtension, uiOptions: any) {
        this.panel = panel;
        this.defaultNpmPath = Environment.createEnv().getNpmPaths();
		...
		this.yeomanui = new YeomanUI(this.rpc, 
			...
			outputChannel, 
			this.logger, 
			{genFilter: this.genFilter, messages: this.messages, defaultNpmPath: this.defaultNpmPath},
